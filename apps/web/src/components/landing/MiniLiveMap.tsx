...
function Scene() {
  return (
    <>
      ...
      {/* Container stacks */}
      {/* Left cluster */}
      <Container position={[-1.8, -1.0, -1.0]} color="#f5801e" floatSpeed={1.1} />
      ...
      <Container position={[0.6, 0.7, -0.2]} color="#f5801e" floatSpeed={0.9} />

      {/* Right cluster */}
      <Container position={[3.2, -1.0, 1.2]} rotation={[0, 0.3, 0]} color="#1e3a5f" floatSpeed={1.0} />
      <Container position={[3.4, -0.15, 1.4]} color="#f5801e" floatSpeed={1.08} scale={[2.4, 0.85, 0.85]} />
  ...
  return (
    <div className="w-full h-full flex items-center justify-center bg-[#0a1628]">
      <div className="flex flex-col items-center gap-3">
        <div className="w-12 h-12 rounded-full border-2 border-[#f5801e]/30 border-t-[#f5801e] animate-spin" />
